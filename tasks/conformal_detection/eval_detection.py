...
if __name__ == "__main__":
    ...
    parser.add_argument("--fake_prob_aggregation_method", type=str, default="max")
    # dset params
    ...
    attributor = DetectorViaAttribution.load_from_checkpoint(args.model_path, fake_prob_aggregation_method=args.fake_prob_aggregation_method)
